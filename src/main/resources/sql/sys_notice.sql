...
(
    ...
    notice_type    char                    not null comment '公告类型（0 通知 1 公告）',
...
INSERT INTO sys_notice (notice_id, notice_title, notice_type, notice_content, status, create_by, create_time, update_by,
                        update_time, remark)
VALUES (1, '温馨提醒：2024-06-18 afro第一版发布', '1', 'vue3+ts+springboot3技术栈', '0', '胡诗涵', '2024-06-18 00:00:00', '胡诗涵',
        '2024-06-18 00:00:00', '管理员');
